...
ALTER TABLE ONLY cdm.cohort ADD CONSTRAINT xpk_cohort_id PRIMARY KEY (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date);
ALTER TABLE ONLY cdm.condition_era ADD CONSTRAINT xpk_condition_era_id PRIMARY KEY (condition_era_id);
ALTER TABLE ONLY cdm.condition_occurrence ADD CONSTRAINT xpk_condition_occurrence_id PRIMARY KEY (condition_occurrence_id);
ALTER TABLE ONLY cdm.cost ADD CONSTRAINT xpk_cost_id PRIMARY KEY (cost_id);
ALTER TABLE ONLY cdm.death ADD CONSTRAINT xpk_death_id PRIMARY KEY (person_id);
ALTER TABLE ONLY cdm.device_exposure ADD CONSTRAINT xpk_device_exposure_id PRIMARY KEY (device_exposure_id);
ALTER TABLE ONLY cdm.dose_era ADD CONSTRAINT xpk_dose_era_id PRIMARY KEY (dose_era_id);
ALTER TABLE ONLY cdm.drug_era ADD CONSTRAINT xpk_drug_era_id PRIMARY KEY (drug_era_id);
ALTER TABLE ONLY cdm.drug_exposure ADD CONSTRAINT xpk_drug_exposure_id PRIMARY KEY (drug_exposure_id);
ALTER TABLE ONLY cdm.location_history ADD CONSTRAINT xpk_location_history_id PRIMARY KEY (location_history_id);
ALTER TABLE ONLY cdm.location ADD CONSTRAINT xpk_location_id PRIMARY KEY (location_id);
ALTER TABLE ONLY cdm.measurement ADD CONSTRAINT xpk_measurement_id PRIMARY KEY (measurement_id);
ALTER TABLE ONLY cdm.note ADD CONSTRAINT xpk_note_id PRIMARY KEY (note_id);
ALTER TABLE ONLY cdm.note_nlp ADD CONSTRAINT xpk_note_nlp PRIMARY KEY (note_nlp_id);
ALTER TABLE ONLY cdm.observation ADD CONSTRAINT xpk_observation_id PRIMARY KEY (observation_id);
ALTER TABLE ONLY cdm.observation_period ADD CONSTRAINT xpk_observation_period_id PRIMARY KEY (observation_period_id);
ALTER TABLE ONLY cdm.payer_plan_period ADD CONSTRAINT xpk_payer_plan_period_id PRIMARY KEY (payer_plan_period_id);
ALTER TABLE ONLY cdm.person ADD CONSTRAINT xpk_person_id PRIMARY KEY (person_id);
ALTER TABLE ONLY cdm.procedure_occurrence ADD CONSTRAINT xpk_procedure_occurrence_id PRIMARY KEY (procedure_occurrence_id);
ALTER TABLE ONLY cdm.provider ADD CONSTRAINT xpk_provider_id PRIMARY KEY (provider_id);
ALTER TABLE ONLY cdm.specimen ADD CONSTRAINT xpk_specimen PRIMARY KEY (specimen_id);
ALTER TABLE ONLY cdm.survey_conduct ADD CONSTRAINT xpk_survey_conduct_id PRIMARY KEY (survey_conduct_id);
ALTER TABLE ONLY cdm.visit_detail ADD CONSTRAINT xpk_visit_detail_id PRIMARY KEY (visit_detail_id);
ALTER TABLE ONLY cdm.visit_occurrence ADD CONSTRAINT xpk_visit_occurrence_id PRIMARY KEY (visit_occurrence_id);
ALTER TABLE ONLY vocabularies.concept_synonym ADD CONSTRAINT uq_concept_synonym UNIQUE (concept_id, concept_synonym_name, language_concept_id);
ALTER TABLE ONLY vocabularies.concept_ancestor ADD CONSTRAINT xpk_concept_ancestor PRIMARY KEY (ancestor_concept_id, descendant_concept_id);
ALTER TABLE ONLY vocabularies.concept_class ADD CONSTRAINT xpk_concept_class PRIMARY KEY (concept_class_id);
ALTER TABLE ONLY vocabularies.concept ADD CONSTRAINT xpk_concept_id PRIMARY KEY (concept_id);
ALTER TABLE ONLY vocabularies.concept_relationship ADD CONSTRAINT xpk_concept_relationship_id PRIMARY KEY (concept_id_1, concept_id_2, relationship_id);
ALTER TABLE ONLY vocabularies.domain ADD CONSTRAINT xpk_domain_id PRIMARY KEY (domain_id);
ALTER TABLE ONLY vocabularies.drug_strength ADD CONSTRAINT xpk_drug_strength PRIMARY KEY (drug_concept_id, ingredient_concept_id);
ALTER TABLE ONLY vocabularies.relationship ADD CONSTRAINT xpk_relationship_id PRIMARY KEY (relationship_id);
ALTER TABLE ONLY vocabularies.source_to_concept_map ADD CONSTRAINT xpk_source_to_concept_map_id PRIMARY KEY (source_vocabulary_id, target_concept_id, source_code, valid_end_date);
ALTER TABLE ONLY vocabularies.vocabulary ADD CONSTRAINT xpk_vocabulary_id PRIMARY KEY (vocabulary_id);
